"""FastAPI application factory for nlp-imdb-textrep.
...
async def lifespan(app: FastAPI):
    print(f"[{datetime.utcnow().isoformat()}] nlp-imdb-textrep service starting")
    ...
    yield
    print(f"[{datetime.utcnow().isoformat()}] nlp-imdb-textrep service shutting down")
