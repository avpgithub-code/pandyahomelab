"""FastAPI application factory for __PROJECT__.
...
async def lifespan(app: FastAPI):
    print(f"[{datetime.utcnow().isoformat()}] __PROJECT__ service starting")
    ...
    yield
    print(f"[{datetime.utcnow().isoformat()}] __PROJECT__ service shutting down")
