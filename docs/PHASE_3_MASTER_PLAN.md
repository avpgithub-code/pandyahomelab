...
| **3c** | `nlp-text8-word2vec`: CBOW vs skip-gram vs fastText on text8, GloVe as reference; trained offline, loaded at startup | .12 / 8022 | L5 | In progress (gate decided 2026-09-25) |
