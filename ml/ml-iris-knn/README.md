...
Iris classification using k-Nearest Neighbors (k-NN) algorithm. This is the first production ML project for pandyaHomeLab, demonstrating the 3-layer architecture pattern and serving as a reference implementation for future projects.
